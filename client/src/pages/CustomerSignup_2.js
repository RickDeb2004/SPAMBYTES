        ...
        <div className=" bg-[url('../public/960x0-1@2x.png')] bg-cover h-screen">
            ...
            <form onSubmit={handleSubmit}>
                <input className="absolute top-[200px] left-[600px]"
                    ...
                    type="address"
                />
                <Select className="absolute top-[400px] left-[480px] w-[500px]"
                    options={options}
                    value={Country}
                    onChange={changeHandler}
                />
                <input className="absolute top-[300px] left-[450px]"
                    value={state}
                    placeholder="Enter State/Territory"
                    onChange={(e) => setState(e.target.value)}
                    type="text"
                />
                <input className="absolute top-[300px] left-[650px]"
                    value={city}
                    placeholder="Enter City"
                    onChange={(e) => setCity(e.target.value)}
                    type="text"
                />
                <input className="absolute top-[300px] left-[850px]"
                    value={pincode}
                    placeholder="Enter city pincode"
                    onChange={(e) => setPincode(e.target.value)}
                    type="number"
                />
                <Button primary type="submit" className="absolute top-[550px] left-[680px]">
                    Continue
                </Button>
            </form>
        </div>
